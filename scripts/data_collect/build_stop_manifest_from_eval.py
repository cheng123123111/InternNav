...
def main():
    ...
    parser.add_argument("--eval-root", required=True, help="Evaluation output root, e.g. logs/habitat/video20")
    ...
    with output_path.open("w", encoding="utf-8") as fout:
        for row in rows:
            ...
            instruction = choose_instruction(row.get("episode_instruction", ""))
