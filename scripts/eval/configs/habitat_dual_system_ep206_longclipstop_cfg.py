...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            ...
            "max_new_tokens": 256,
            "vis_debug": True,
            "vis_debug_path": "./logs/habitat/ep206_longclipstop/vis_debug",
    ...
    env=EnvCfg(
        env_type='habitat',
        env_settings={
            'config_path': 'scripts/eval/configs/vln_r2r_ep206.yaml',
        },
    ),
    eval_type='habitat_vln',
    eval_settings={
        "output_path": "./logs/habitat/ep206_longclipstop",
        "save_video": True,
        "epoch": 0,
