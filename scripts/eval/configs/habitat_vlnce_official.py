# Official-style VLN-CE evaluation config
# Based on habitat_dual_system_cfg.py with correct data paths
...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            ...
            "vis_debug_path": "./logs/habitat_official/vis_debug",
        },
    ),
    env=EnvCfg(
        env_type='habitat',
        env_settings={
            ...
            'config_path': 'scripts/eval/configs/vln_r2r_quicktest_official.yaml',
        },
    ),
    eval_type='habitat_vln',
    eval_settings={
        # all current parse args
        "output_path": "./logs/habitat_official",  # output directory for logs/results
